 ...
 * quit log: [command ] + q
-------
> ####  :camera_with_flash:  Taking snapshot +  Uploading
1. On terminal get into git folder
     ##### when see  ➜ intro_to_git git:(main) ✗ git status
2. Add file to git
     ##### ➜ intro_to_git git:(main) ✗ git add facts.txt
3. Check git status
    ##### ➜ intro_to_git git:(main) ✗ git status
     ##### Should say no commits yet
4.  Take a snapshot
     ##### ➜ intro_to_git git:(main) ✗ git commit -m "added first fact"
3. Check git status again
     ##### Should say:  nothing to commit, working tree clean
4. Check the log
    ##### ➜ intro_to_git git:(main) gitlog
-------------------------------
